...
%            soldir: '/yourdir/MATLABCODE/KCMIX2/KCMIXCODE/solarV2'
...
iGasDoOD = [1];        %% only do WV (includes continuum) and CO2
...
dirin = '/yourdir/KCMIX2/PACKAGE_UPnDOWNLOOK_2011/RTPFILES/';
fin   = 'desert_op.rtp'; 
